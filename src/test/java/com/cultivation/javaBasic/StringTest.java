...
class StringTest {
    ...
    void will_create_new_string_when_concat() {
        ...
        // It is really easy to pass the test. But you have to tell why.
        // <--start
        final Optional<Boolean> areSame = Optional.of(originalString == copyOfOriginalString);
        // --end-->
    ...
    void should_convert_unicode_escape() {
        ...
        // れ - U+308c
        // <--Start
//        System.out.println((char)Integer.parseInt("306a", 16));
        String unicodeString = "\u306a\u306b\u3053\u308c";
        final String actual = StringEscapeUtils.unescapeJava(unicodeString);
        // --End-->
